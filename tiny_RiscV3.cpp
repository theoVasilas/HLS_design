...
output  R_type(ac_int<7, false> opcode, ac_int<5, false> rd, ac_int<3, false> func3, ac_int<5, false> rs1, ac_int<5, false> rs2, ac_int<7, false> func7) {
...
output  S_type(ac_int<7, false> opcode, ac_int<3, false> func3, ac_int<5, false> rs1, ac_int<5, false> rs2, ac_int<12, false> imm12) {
...
output  I_type(ac_int<7, false> opcode, ac_int<5, false> rd, ac_int<3, false> func3, ac_int<5, false> rs1, ac_int<12, false> imm12) {
...
output  U_type(ac_int<7, false> opcode, ac_int<5, false> rd, ac_int<20, false> imm20) {
...
output  Decoder(ac_int<32, false> instr) {
